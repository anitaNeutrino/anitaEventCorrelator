...
void makeSimpleDST(int run, int numEnts, char *baseDir, char *outDir=0);
...
int main(int argc, char **argv) {
  ...
  // makeSimpleDST(run,0,"/Users/simonbevan/Desktop/","/Users/simonbevan/ANITA/outfiles/");

  //makeSimpleDST(run,0,"http://www.hep.ucl.ac.uk/uhen/anita/private/monitor2/runs/fromLoki/","/home/rjn/anita/data/corTrees");
  // makeSimpleDST(run,0,"http://www.hep.ucl.ac.uk/uhen/anita/private/monitor2/runs/fromLoki/","../outFiles/");

  TStopwatch stopy;
  stopy.Start();
  //  makeSimpleDST(run,0,"/Users/simonbevan/Desktop/","/Users/simonbevan/ANITA/outfiles/");
  makeSimpleDST(run,numEnts,"/unix/anita1/flight0809/root","/unix/anita1/rjn/corTrees/justTaylorSvn220509");
  stopy.Stop();
  std::cout << "Run " << run << "\n";
  std::cout << "CPU Time: " << stopy.CpuTime() << "\t" << "Real Time: "
   ...
   //makeSimpleDST(run,0,"/unix/anita3/flight0809/root","/unix/anita3/rjn/corTrees");

}
  
void makeSimpleDST(int run, int numEnts, char *baseDir, char *outDir) {
  ...
  TFile *fpOut;
  if(outDir) {
     sprintf(outName,"%s/simpleDST%d.root",outDir,run);
  }
  else {
     sprintf(outName,"simpleDST%d.root",run);
  }
  ...
  Int_t labChip;
  TTree *dstTree = new TTree("dstTree","Tree of Correlation Summaries");
  dstTree->Branch("cor","CorrelationSummary",&theCor);
  dstTree->Branch("labChip",&labChip,"labChip/I");
  ...
  for(Long64_t entry=0;entry<maxEntry;entry++) {
     ...
     if(header->eventNumber!=8381355) continue;
