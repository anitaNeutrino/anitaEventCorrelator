...
double GeoMagnetic::Y_atSpherical(UInt_t unixTime, double r,  double theta, double phi){
  prepareGeoMagnetics();
  double V0 = getPotentialAtSpherical(unixTime, r, theta, phi-0.5*dPhi);
  double V1 = getPotentialAtSpherical(unixTime, r, theta, phi+0.5*dPhi);
...
double GeoMagnetic::Z_atSpherical(UInt_t unixTime, double r,  double theta, double phi){
  ...
  double V0 = getPotentialAtSpherical(unixTime, r-0.5*dr, theta, phi);
  double V1 = getPotentialAtSpherical(unixTime, r+0.5*dr, theta, phi);
