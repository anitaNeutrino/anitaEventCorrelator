///////////////////////////////////////////////////////////////////////////////
/////  CorrelationSummaryAnita3.h        ANITA-3 Correlation Summary      /////
/////                                                                     /////
/////  Description:                                                       /////
...
#ifndef CORRELATIONSUMMARYANITA3_H
#define CORRELATIONSUMMARYANITA3_H
...
*/
class CorrelationSummaryAnita3: public TObject
{


 public:
   CorrelationSummaryAnita3(); ///< Default constructor
   ~CorrelationSummaryAnita3(); ///< Destructor
  ...
  */
  ...
  int secondAnt[NUM_CORRELATIONS_ANITA3]; ///< The index of the second antenna in the 49 possible pairs (3 top-middle, 3 middle-bottom, 6 left-right, 6 diagonal, 6 outside-centre, 6 outside-neighbour, 4 diagonal with neighbour, 13 top-bottom combinations).
  double maxCorVals[NUM_CORRELATIONS_ANITA3]; ///< The maximum correlation value for each of the 49 possible correlations (3 top-middle, 3 middle-bottom, 6 left-right, 6 diagonal, 6 outside-centre, 6 outside-neighbour, 4 diagonal with neighbour, 13 top-bottom combinations).
  double maxCorTimes[NUM_CORRELATIONS_ANITA3]; ///< The time of the maximum correlation value for each of the 49 possible correlations (3 top-middle, 3 middle-bottom, 6 left-right, 6 diagonal, 6 outside-centre, 6 outside-neighbour, 4 diagonal with neighbour, 13 top-bottom combinations).
  double rmsCorVals[NUM_CORRELATIONS_ANITA3]; ///< The rms correlation value for each of the 49 possible correlations (3 top-middle, 3 middle-bottom, 6 left-right, 6 diagonal, 6 outside-centre, 6 outside-neighbour, 4 diagonal with neighbour, 13 top-bottom combinations).




  double secondCorVals[NUM_CORRELATIONS_ANITA3][2]; ///< The peak of the next highest correlation values (tore both left and right vals).
  double secondCorTimes[NUM_CORRELATIONS_ANITA3][2]; ///< The time of the next highest correlation values (tore both left and right vals).

  //Time Thingies
  //  double deltaT[NUM_CORRELATIONS_ANITA3]; is maxCorTimes
  double deltaTErr[NUM_CORRELATIONS_ANITA3]; ///< The error on each of the 49 deltaTs (no idea right now what this means).
  ...
  Double_t fAntPhi[NUM_CORRELATIONS_ANITA3][2]; ///< A lookup table for antenna postions.
  Double_t fAntR[NUM_CORRELATIONS_ANITA3][2]; ///< A lookup table for antenna postions.
  Double_t fAntZ[NUM_CORRELATIONS_ANITA3][2]; ///< A lookup table for antenna postions.
  
  


  ClassDef(CorrelationSummaryAnita3,4); ///< One of ROOT's magic macros.
};


#endif //CORRELATIONSUMMARYANITA3_H
